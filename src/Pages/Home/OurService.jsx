...
const OurService = () => {
  ...
  <div className="card-body">
    ...
    <div className="card-actions justify-end">
      <div className="badge badge-outline">23/11/2023</div> 
      <div className="badge badge-outline">Monday</div>
    </div>
  </div>
</div>
            <div className="card w-96 bg-base-100">
  ...
  <div className="card-body">
    ...
    <p>Powering Progress Through Innovation and Discovery.</p>
    <div className="card-actions justify-end">
      <div className="badge badge-outline">1/12/2023</div> 
      <div className="badge badge-outline">Sunday</div>
    </div>
  </div>
</div>
            <div className="card w-96 bg-base-100">
  ...
  <div className="card-body">
    ...
    <p>Computer science drives digital innovation.</p>
    <div className="card-actions justify-end">
      <div className="badge badge-outline">28/12/2023</div> 
      <div className="badge badge-outline">Friday</div>
    </div>
  </div>
</div>
        </div>
